...
x = divide_mutliply_add_four_numbers(4,2,77,10000)
print(x)
...
def add_two_strings(string1, string2):
    ...
    return sumOfStrings
x = add_two_strings("Hockey","Basketball")
print(x)
...
x = my_favorite_color("orange", "Turquise")
print(x)
